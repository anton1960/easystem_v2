			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"eaeasystem-display": {
								"semanticObject": "eaeasystem",
								"action": "display",
								"description": "Enterprise Architecture System",
								"title": "EA - Systeme",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ea.easystem",
									"url": sap.ui.require.toUrl("ea/easystem")
								}
							}
						}
					}
